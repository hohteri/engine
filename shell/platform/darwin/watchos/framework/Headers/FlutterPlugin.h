...
#if __WATCH_OS_VERSION_MAX_ALLOWED >= __WATCHOS_3_0
    <UNUserNotificationCenterDelegate>
#endif
@optional
/**
 * Called if this has been registered for `WKExtensionDelegate` callbacks.
 *
 ...
 * Called if this has been registered for `WKExtensionDelegate` callbacks.
 *
- (void)application:(id<WKExtensionDelegate>)application
...
- (BOOL)application:(WKExtension*)application
    didReceiveRemoteNotification:(NSDictionary*)userInfo
          fetchCompletionHandler:(void (^)(WKBackgroundFetchResult result))completionHandler;

/**
 * Calls all plugins registered for `WKExtensionDelegate` callbacks.
 */
- (void)application:(WKExtension*)application
 ...
 */
- (BOOL)application:(WKExtension*)application
    performFetchWithCompletionHandler:(void (^)(WKBackgroundFetchResult result))completionHandler;
