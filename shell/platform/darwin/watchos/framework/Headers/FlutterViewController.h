 ...
 */
FLUTTER_EXPORT
@interface FlutterViewController : WKInterfaceController <FlutterTextureRegistry, FlutterPluginRegistry>
 ...
 */
@property(strong, nonatomic) WKInterfaceObject* splashScreenView;
