...
#include "flutter/shell/platform/darwin/watchos/framework/Source/FlutterCallbackCache_Internal.h"
...
@implementation FlutterPluginAppLifeCycleDelegate {
  ...
  WKRefreshBackgroundTask* _debugBackgroundTask;
