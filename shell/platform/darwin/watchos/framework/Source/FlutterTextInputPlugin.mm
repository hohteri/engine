...
@interface FlutterTextInputView : WKInterfaceObject <WKInterfaceTextField>
 ...
 */
@interface FlutterTextInputViewAccessibilityHider : WKInterfaceObject {
}
...
- (WKInterfaceObject<WKInterfaceTextField>*)textInputView {
  return _activeView;
}
