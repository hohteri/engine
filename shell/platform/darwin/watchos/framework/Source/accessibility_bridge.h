...
#include "flutter/shell/platform/darwin/watchos/framework/Source/FlutterTextInputPlugin.h"
 ...
 * Flutter uid.
 */
@interface FlutterCustomAccessibilityAction : NSObject
...
class AccessibilityBridge final {
 public:
  AccessibilityBridge(WKInterfaceObject* view,
  ...
  WKInterfaceTextField* textInputView();

  WKInterfaceObject* view() const { return view_; }
