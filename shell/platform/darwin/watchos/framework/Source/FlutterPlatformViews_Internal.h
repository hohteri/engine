...
#include "flutter/shell/platform/darwin/watchos/framework/Headers/FlutterPlatformViews.h"
...
@interface FlutterTouchInterceptingView : NSObject
- (instancetype)initWithEmbeddedView:(NSObject*)embeddedView
...
@interface ChildClippingView : NSObject
...
struct FlutterPlatformViewLayer {
  FlutterPlatformViewLayer(fml::scoped_nsobject<WKInterfaceObject> overlay_view,
                           std::unique_ptr<IOSSurface> ios_surface,
                           std::unique_ptr<Surface> surface);

  ~FlutterPlatformViewLayer();

  fml::scoped_nsobject<WKInterfaceObject> overlay_view;
  std::unique_ptr<IOSSurface> ios_surface;
  std::unique_ptr<Surface> surface;
...
class FlutterPlatformViewsController {
 public:
  ...
  void SetFlutterView(WKInterfaceObject* flutter_view);

  void SetFlutterViewController(WKInterfaceController* flutter_view_controller);
 ...
 private:
  ...
  fml::scoped_nsobject<WKInterfaceObject> flutter_view_;
  fml::scoped_nsobject<WKInterfaceController> flutter_view_controller_;
  ...
  std::map<int64_t, fml::scoped_nsobject<NSObject>> root_views_;
  ...
  NSObject* ReconstructClipViewsChain(int number_of_clips,
                                    WKInterfaceObject* platform_view,
                                    NSObject* head_clip_view);
  ...
  void ApplyMutators(const MutatorsStack& mutators_stack, NSObject* embedded_view);
