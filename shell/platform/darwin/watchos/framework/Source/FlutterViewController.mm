...
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterPlatformViews_Internal.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterViewController_Internal.h"
...
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterBinaryMessengerRelay.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterEngine_Internal.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterPlatformPlugin.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterTextInputDelegate.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterTextInputPlugin.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/FlutterView.h"
#import "flutter/shell/platform/darwin/watchos/framework/Source/platform_message_response_darwin.h"
#import "flutter/shell/platform/darwin/watchos/platform_view_ios.h"
...
@implementation FlutterViewController {
  ...
  fml::scoped_nsobject<WKInterfaceObject> _splashScreenView;
...
- (instancetype)initWithEngine:(FlutterEngine*)engine
  ...
  NSAssert(engine != nil, @"Engine is required");
    self = [super init]; //WithNibName:nibName bundle:nibBundle];
  if (self) {
    _viewOpaque = YES;
...
- (instancetype)initWithProject:(nullable FlutterDartProject*)project
                        nibName:(nullable NSString*)nibName
                         bundle:(nullable NSBundle*)nibBundle {
    self = [super init]; //initWithNibName:nibName bundle:nibBundle];
  if (self) {
    _viewOpaque = YES;
    _weakFactory = std::make_unique<fml::WeakPtrFactory<FlutterViewController>>(self);
...
//    [_splashScreenView.get() removeFromSuperview];
  ...
  WKInterfaceObject* splashScreenView = self.splashScreenView;
...
- (void)removeSplashScreenView:(dispatch_block_t _Nullable)onComplete {
  ...
  //WKInterfaceObject* splashScreen = _splashScreenView.get();
  _splashScreenView.reset();/*
...
- (WKInterfaceObject*)splashScreenView {
...
- (BOOL)loadDefaultSplashScreenView {
  ...
  WKInterfaceObject* splashView = [self splashScreenFromStoryboard:launchscreenName];
  if (!splashView) {
...
- (WKInterfaceObject*)splashScreenFromStoryboard:(NSString*)name {
...
- (WKInterfaceObject*)splashScreenFromXib:(NSString*)name {
    /*
...
- (void)setSplashScreenView:(WKInterfaceObject*)view {
  if (!view) {
...
- (void)onOrientationPreferencesUpdated:(NSNotification*)notification {
  ...
  /*dispatch_async(dispatch_get_main_queue(), ^{
    NSDictionary* info = notification.userInfo;
      ...
      NSNumber* update = nil; // info[@(flutter::kOrientationUpdateNotificationKey)];
...
- (NSUInteger)supportedInterfaceOrientations {
    return 0;// _orientationPreferences;
}
...
- (void)onPreferredStatusBarStyleUpdated:(NSNotification*)notification {
  ...
  /*dispatch_async(dispatch_get_main_queue(), ^{
    NSDictionary* info = notification.userInfo;
      ...
      NSNumber* update = nil; //info[@(flutter::kOverlayStyleUpdateNotificationKey)];
